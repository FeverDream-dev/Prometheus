...
from prometheus_cli.tui_state import TuiSnapshot, collect_demo_snapshot
...
class TestStepContent:
    ...
    def test_project_folder_shows_path(self, snap):
        ...
        joined = strip_markup(" ".join(str(l) for l in lines))
    ...
    def test_pull_step_mentions_confirmation(self, snap):
        ...
        joined = strip_markup(" ".join(str(l) for l in lines)).lower()
